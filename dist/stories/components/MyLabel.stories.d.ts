...
export declare const customColor: ComponentStory<({ allCaps, color, label, size, fontColor, backgroundColor }: import("../../components/MyLabel").MyLabelProps) => JSX.Element>;
export declare const customBackground: ComponentStory<({ allCaps, color, label, size, fontColor, backgroundColor }: import("../../components/MyLabel").MyLabelProps) => JSX.Element>;
